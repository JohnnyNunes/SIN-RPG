...
Scene_Battle.prototype.createAllWindows = function() {
	...
	this._statusWindow.y = Graphics.boxHeight - this._statusWindow.height - 10;
...
/*Window_BattleStatus.prototype.yOffset = function() {
	return 200;
};*/
...
Window_BattleStatus.prototype.drawActorHp = function(actor, x, y, width) {
	...
	this.drawGauge(x + this.textWidth(TextManager.hpA) + 135, y + 5, width, actor.hpRate(), color1, color2);
	this.drawText(TextManager.hpA, x + 255, y + 5, 44);
	this.contents.fontSize += 4;
};
...
Window_BattleStatus.prototype.drawActorTp = function(actor, x, y, width) {
	...
	this.contents.fontSize -= 4;
	this.drawGauge(x + this.textWidth(TextManager.tp) + 135 - 57 - 171, y + 5, width+20, actor.tpRate(), color1, color2);
	this.drawText(TextManager.tp, x + 255, y + 5, 44);
	this.contents.fontSize += 4;
};
...
Window_BattleStatus.prototype.drawGauge = function(x, y, width, rate, color1, color2) {
	...
	var gaugeY = y + this.lineHeight() - 24 + 5;
	this.contents.fillRect(x + 145, gaugeY, width, 15, this.gaugeBackColor());
	this.contents.gradientFillRect(x + 145, gaugeY, fillW, 15, color1, color2);
};
...
Window_BattleStatus.prototype.drawItem = function(index) {
	...
	this.drawActorHp(actor,  rect.x - 220, rect.y, levelOffset);
	this.drawCurrentAndMax(actor.hp, actor.mhp, rect.x + levelOffset + 6 + this.textWidth(TextManager.hpA) - 177 - 4, rect.y + 5, 200, 
		this.hpColor(actor), this.normalColor());

	this.drawActorTp(actor, rect.x + levelOffset*2 - 15 + 171, rect2.y, 100);
	this.drawCurrentAndMax(actor.tp, actor.mtp, rect.x + levelOffset*2 + 6 + this.textWidth(TextManager.tp) + 128 - 50 + 8, rect2.y + 5, 200, 
		this.hpColor(actor), this.normalColor());
...
Window_BattleStatus.prototype.hpGaugeColor2 = function() {
	return this.textColor(21); //3 light
};

Window_BattleStatus.prototype.tpGaugeColor1 = function() {
	return this.textColor(29);
};

Window_BattleStatus.prototype.tpGaugeColor2 = function() {
	return this.textColor(29);
};
...
Window_ActorCommand.prototype.windowHeight = function() {
	return 46; //Graphics.boxHeight/7 - 30
};
...
Window_ActorCommand.prototype.drawItem = function(index) {
	if(_.images) {
		...
		sprite.x = rect.x + (rect.width/2) + (this.textPadding()*2) + Graphics.boxWidth/2 - 114;
		sprite.y = rect.y + (rect.height) - this.textPadding() + 500; //+ 25 Lower Commands
