...
(function(_) {
	...
	TimedAttackSystem.prototype.showResults = function() {
		...
		if(_.parent === 'actor') {
			...
			this._results.x = this._resultActor.x + 365;
			this._results.y = this._resultActor.y + (this._resultActor._mainSprite.height/2) - 20;
			this._results.setup('bla');
	...
	Sprite_TimedAttackResults.prototype.createDigits = function(baseRow, string) {
	    ...
	    for(var i = 0; i < string.length; i++) {
	        ...
	        sprite.bitmap.drawText(string.substring(i, i+1), h/2, w/2, w, h, 'center');
